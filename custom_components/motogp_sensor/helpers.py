...
def parse_live_timing(payload: dict[str, Any]) -> dict[str, Any]:
        ...
        riders.append(
            {
                ...
                "text_color": r.get("text_color") or "",
                ...
                "status_id": r.get("status_id") or "",
                "trac_status": r.get("trac_status") or "",
            }
        )
    ...
    return {
        ...
        "session_type": head.get("session_type"),
        "duration": head.get("duration") or "",
        "circuit_id": head.get("circuit_id") or "",
        "event_id": head.get("event_id") or "",
        "category": head.get("category") or "",
        "championship_id": head.get("championship_id") or "",
